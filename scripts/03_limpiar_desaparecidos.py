"""
SCRIPT 03: LIMPIAR Y UNIFICAR PERSONAS DESAPARECIDAS
=====================================================
...
RUTA_BASE = r"C:\Users\Erick Zambrano\Desktop\linkedin\PROYECTOS\DATOS SUCIOS\PERSONAS DESAPARECIDAS"
RUTA_SALIDA = r"C:\Users\Erick Zambrano\Desktop\linkedin\PROYECTOS\02_criminalidad_ecuador\datos_limpios"
os.makedirs(RUTA_SALIDA, exist_ok=True)

print("=" * 80)
print("📊 LIMPIEZA Y UNIFICACIÓN: PERSONAS DESAPARECIDAS")
print("=" * 80)

# Leer datos históricos
print("\n📁 Leyendo datos históricos (2017-2024)...")
archivo_hist = os.path.join(RUTA_BASE, "MDI_PersonasDesaparecidas_PM_2017_2024.xlsx")
...
archivo_2025 = os.path.join(RUTA_BASE, "MDI_PersonasDesaparecidas_PM_2025_Enero_Noviembre.xlsx")
...
# Exportar
archivo_salida = os.path.join(RUTA_SALIDA, "03_personas_desaparecidas_unificado.csv")
