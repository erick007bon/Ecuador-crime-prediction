"""
SCRIPT 04: LIMPIAR Y UNIFICAR DETENIDOS/APREHENDIDOS
====================================================
Fuente: Ministerio del Interior - Ecuador
Datos: 100% reales, sin modificaciones inventadas
NOTA: Este archivo es grande (~63MB), puede tomar unos minutos
"""
...
RUTA_BASE = r"C:\Users\Erick Zambrano\Desktop\linkedin\PROYECTOS\DATOS SUCIOS\PERSONAS PRESAS"
RUTA_SALIDA = r"C:\Users\Erick Zambrano\Desktop\linkedin\PROYECTOS\02_criminalidad_ecuador\datos_limpios"
os.makedirs(RUTA_SALIDA, exist_ok=True)

print("=" * 80)
print("📊 LIMPIEZA Y UNIFICACIÓN: DETENIDOS/APREHENDIDOS")
print("=" * 80)

# Leer datos históricos (archivo grande!)
print("\n📁 Leyendo datos históricos (2019-2024)... [ARCHIVO GRANDE - ESPERE]")
archivo_hist = os.path.join(RUTA_BASE, "MDI_DetenidosAprehendidos_PM_2019_2024.xlsx")
...
archivo_2025 = os.path.join(RUTA_BASE, "MDI_DetenidosAprehendidos_PM_2025_Enero_Noviembre.xlsx")
...
# Exportar
archivo_salida = os.path.join(RUTA_SALIDA, "04_detenidos_unificado.csv")
